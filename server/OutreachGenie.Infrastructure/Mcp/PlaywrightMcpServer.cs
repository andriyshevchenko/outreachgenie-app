...
/// Provides web navigation, element interaction, and screenshot capabilities.
/// </summary>
public sealed class PlaywrightMcpServer : IMcpServer
{
    private readonly IMcpTransport transport;
    private readonly ILogger<PlaywrightMcpServer> logger;
    private int requestId;

    /// <summary>
    /// Initializes a new instance of the <see cref="PlaywrightMcpServer"/> class.
    /// </summary>
    /// <param name="transport">The transport for communication.</param>
    /// <param name="logger">Logger for server operations.</param>
    public PlaywrightMcpServer(IMcpTransport transport, ILogger<PlaywrightMcpServer> logger)
    {
    ...
    /// <inheritdoc/>
    public string Name => "Playwright Browser Automation";
    ...
    {
        this.logger.LogInformation("Connecting to Playwright MCP server");
        ...
        this.logger.LogInformation("Playwright MCP server initialized");
    }

    /// <inheritdoc/>
    public async Task DisconnectAsync(CancellationToken cancellationToken = default)
    {
        this.logger.LogInformation("Disconnecting from Playwright MCP server");
    ...
    public async Task<IReadOnlyList<McpTool>> ListToolsAsync(CancellationToken cancellationToken = default)
    {
        ...
        this.logger.LogInformation("Retrieved {ToolCount} tools from Playwright", tools.Count);
        return tools;
    }
    ...
    {
        this.logger.LogInformation("Calling Playwright tool: {ToolName}", name);
